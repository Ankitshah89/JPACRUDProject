...
<body>
	<div class= "centered">
				...
				<form:form action="create.do" method="POST" modelAttribute="country">
				
				<form:label path="country">Country: </form:label>
					<form:input path="country" value="${country.country }" required="required"/>
					<form:errors path="country" />
					<br />
					<form:label path="latitude">Latitude: </form:label>
					<form:input path="latitude" value="${country.latitude }" required="required"/>
					<form:errors path="latitude" />
					<br />
					<form:label path="longitude">Longitude: </form:label>
					<form:input path="longitude" value="${country.longitude }" required="required"/>
